...
@Entity
@Table(name = "sdn_dob", schema = "ofac")
public class SdnDOB {
    @Id
    @Column(name = "sdn_dob_id", columnDefinition = "serial")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private int sdn_dob_id;
    ...
    public int getSdn_dob_id() {
        return sdn_dob_id;
    }

    public void setSdn_dob_id(int sdn_dob_id) {
        this.sdn_dob_id = sdn_dob_id;
    }
