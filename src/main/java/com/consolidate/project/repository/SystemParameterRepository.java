...
public interface SystemParameterRepository extends JpaRepository<SystemParameter, Integer> {
    ...
    @Modifying
    @Query(value = "UPDATE cd.system_parameter SET parameter_name = :parameter_name,parameter_value=:parameter_value,updated_by=:updated_by,updated_date=current_timestamp,status=:status WHERE parametersystem_id =:parametersystem_id ", nativeQuery = true)
    void updateSystemParameter(@Param("parameter_name") String parameter_name, @Param("parameter_value") String parameter_value,
                               @Param("updated_by") String updated_by, @Param("status") String status, @Param("parametersystem_id") int parametersystem_id);
    ...
    List<SystemParameter> getParameterByNameExceptId(@Param("parameter_name") String parameter_name, @Param("parametersystem_id") int parametersystem_id);
